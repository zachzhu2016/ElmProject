...
var author$project$Api$userUnwrap = function (viewerDecoder) {
...
var author$project$Api$application = F3(
	function (viewerDecoder, cartDecoder, config) {
		var init = F3(
				...
				var maybeViewer = elm$core$Result$toMaybe(
					A2(
						...
						elm$json$Json$Decode$decodeString(
							author$project$Api$userUnwrap(viewerDecoder)),
						A2(elm$json$Json$Decode$decodeValue, elm$json$Json$Decode$string, flags)));
				var maybeCart = elm$core$Result$toMaybe(
					A2(
						elm$core$Result$andThen,
						elm$json$Json$Decode$decodeString(cartDecoder),
						A2(elm$json$Json$Decode$decodeValue, elm$json$Json$Decode$string, flags)));
				return A4(config.init, maybeCart, maybeViewer, url, navKey);
			});
...
var author$project$Cart$Filled = function (a) {
	return {$: 'Filled', a: a};
};
...
var author$project$Cart$Item = F4(
	function (id, name, price, qty) {
		return {id: id, name: name, price: price, qty: qty};
	});
var elm$json$Json$Decode$int = _Json_decodeInt;
var author$project$Cart$itemDecoder = A3(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'id',
				elm$json$Json$Decode$string,
				elm$json$Json$Decode$succeed(author$project$Cart$Item)))));
var author$project$Cart$dictDecoder = elm$json$Json$Decode$dict(author$project$Cart$itemDecoder);
var author$project$Cart$decoder = A2(elm$json$Json$Decode$map, author$project$Cart$Filled, author$project$Cart$dictDecoder);
...
var author$project$Main$Redirect = F2(
	function (a, b) {
		return {$: 'Redirect', a: a, b: b};
	});
...
var author$project$Main$GotCartMsg = function (a) {
	return {$: 'GotCartMsg', a: a};
};
var author$project$Main$GotFoodMsg = function (a) {
	return {$: 'GotFoodMsg', a: a};
};
...
var author$project$Cart$Empty = {$: 'Empty'};
var author$project$Page$Food$toCart = function (model) {
	return model.cart;
};
var author$project$Page$Home$toCart = function (model) {
	return model.cart;
};
var author$project$Page$Login$toCart = function (model) {
	return model.cart;
};
var author$project$Page$Register$toCart = function (model) {
	return model.cart;
};
var author$project$Main$toCart = function (page) {
	switch (page.$) {
		case 'Redirect':
			var cart = page.b;
			return cart;
		case 'NotFound':
			return author$project$Cart$Empty;
		case 'Home':
			var home = page.a;
			return author$project$Page$Home$toCart(home);
		case 'Login':
			var login = page.a;
			return author$project$Page$Login$toCart(login);
		case 'Register':
			var register = page.a;
			return author$project$Page$Register$toCart(register);
		case 'Food':
			var food = page.a;
			return author$project$Page$Food$toCart(food);
		default:
			var cart = page.a;
			return cart.cart;
	}
};
var author$project$Page$Cart$toSession = function (model) {
	return model.session;
};
var author$project$Page$Food$toSession = function (model) {
	return model.session;
};
...
var author$project$Main$toSession = function (page) {
	switch (page.$) {
		...
		case 'Food':
			var food = page.a;
			return author$project$Page$Food$toSession(food);
		default:
			var cart = page.a;
			return author$project$Page$Cart$toSession(cart);
	}
};
...
var author$project$Page$Cart$init = F2(
...
var author$project$Api$get = F3(
	function (url, toResult, decoder) {
		return author$project$Api$Endpoint$request(
			{
				body: elm$http$Http$emptyBody,
				expect: A2(elm$http$Http$expectJson, toResult, decoder),
				headers: _List_Nil,
				method: 'GET',
...
var author$project$Api$Endpoint$url = function (paths) {
	return author$project$Api$Endpoint$Endpoint(
		A3(elm$url$Url$Builder$crossOrigin, 'https://api.neora.co', paths, _List_Nil));
};
var author$project$Food$Slug$toString = function (_n0) {
	var str = _n0.a;
	return str;
};
var author$project$Api$Endpoint$food = function (slug) {
	return author$project$Api$Endpoint$url(
		_List_fromArray(
			[
				'food',
				author$project$Food$Slug$toString(slug)
			]));
};
var NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$hardcoded = A2(elm$core$Basics$composeR, elm$json$Json$Decode$succeed, NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom);
var author$project$Food$Food = F2(
	function (a, b) {
		return {$: 'Food', a: a, b: b};
	});
var author$project$Food$Full = {$: 'Full'};
var author$project$Food$Internals = F2(
	function (slug, metadata) {
		return {metadata: metadata, slug: slug};
	});
var author$project$Food$Metadata = F5(
	function (id, name, restaurant, price, description) {
		return {description: description, id: id, name: name, price: price, restaurant: restaurant};
	});
...
var author$project$Food$metadataDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'description',
	A2(
		elm$json$Json$Decode$map,
		...
		A3(
			...
			A3(
				...
				A3(
					...
					'id',
					elm$json$Json$Decode$int,
					elm$json$Json$Decode$succeed(author$project$Food$Metadata))))));
var author$project$Food$Slug$Slug = function (a) {
	return {$: 'Slug', a: a};
};
var author$project$Food$Slug$decoder = A2(elm$json$Json$Decode$map, author$project$Food$Slug$Slug, elm$json$Json$Decode$string);
var author$project$Food$internalsDecoder = A2(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
	author$project$Food$metadataDecoder,
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'slug',
		author$project$Food$Slug$decoder,
		elm$json$Json$Decode$succeed(author$project$Food$Internals)));
var author$project$Food$fullDecoder = A2(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$hardcoded,
	author$project$Food$Full,
	A2(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
		author$project$Food$internalsDecoder,
		elm$json$Json$Decode$succeed(author$project$Food$Food)));
var author$project$Page$Food$CompletedLoadFood = function (a) {
	return {$: 'CompletedLoadFood', a: a};
};
var author$project$Page$Food$Loading = {$: 'Loading'};
var author$project$Page$Food$init = F3(
	function (cart, session, slug) {
		return _Utils_Tuple2(
			{cart: cart, errors: _List_Nil, food: author$project$Page$Food$Loading, session: session},
			A3(
				author$project$Api$get,
				author$project$Api$Endpoint$food(slug),
				author$project$Page$Food$CompletedLoadFood,
				author$project$Food$fullDecoder));
	});
var author$project$Api$Endpoint$foods = author$project$Api$Endpoint$url(
	_List_fromArray(
		['food']));
var author$project$Page$Home$CompletedGridLoad = function (a) {
	return {$: 'CompletedGridLoad', a: a};
};
var author$project$Page$Home$Loading = {$: 'Loading'};
var author$project$Food$Preview = {$: 'Preview'};
var author$project$Food$previewDecoder = A2(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$hardcoded,
	author$project$Food$Preview,
	A2(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
		author$project$Food$internalsDecoder,
		elm$json$Json$Decode$succeed(author$project$Food$Food)));
var author$project$FoodGrid$FoodGrid = function (a) {
	return {$: 'FoodGrid', a: a};
};
var author$project$FoodGrid$fromList = function (list) {
	return author$project$FoodGrid$FoodGrid(
		{values: list});
};
var author$project$Page$Home$gridDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'foods',
	elm$json$Json$Decode$list(author$project$Food$previewDecoder),
	elm$json$Json$Decode$succeed(author$project$FoodGrid$fromList));
var author$project$Page$Home$init = F2(
	function (cart, session) {
		return _Utils_Tuple2(
			{cart: cart, foodGrid: author$project$Page$Home$Loading, session: session},
			A3(author$project$Api$get, author$project$Api$Endpoint$foods, author$project$Page$Home$CompletedGridLoad, author$project$Page$Home$gridDecoder));
	});
...
var author$project$Page$Register$init = F2(
	function (cart, session) {
		return _Utils_Tuple2(
			{
				cart: cart,
				form: {confirm: '', email: '', firstname: '', lastname: '', password: ''},
				problems: _List_Nil,
				session: session
			},
			elm$core$Platform$Cmd$none);
...
var author$project$Main$changeRouteTo = F2(
	function (maybeRoute, model) {
		...
		var cart = author$project$Main$toCart(model);
			...
			switch (maybeRoute.a.$) {
				...
				case 'Home':
					...
					return A4(
						...
						model,
						A2(author$project$Page$Home$init, cart, session));
				case 'Login':
					...
					return A4(
						...
						model,
						A2(author$project$Page$Login$init, cart, session));
				case 'Register':
					...
					return A4(
						...
						model,
						A2(author$project$Page$Register$init, cart, session));
				case 'Food':
					var slug = maybeRoute.a.a;
					return A4(
						author$project$Main$updateWith,
						author$project$Main$Food,
						author$project$Main$GotFoodMsg,
						model,
						A3(author$project$Page$Food$init, cart, session, slug));
				default:
					var _n6 = maybeRoute.a;
					return A4(
						author$project$Main$updateWith,
						author$project$Main$Cart,
						author$project$Main$GotCartMsg,
						model,
						A2(author$project$Page$Cart$init, session, cart));
			}
		}
	});
...
var author$project$Food$Slug$urlParser = A2(
	elm$url$Url$Parser$custom,
	'SLUG',
	function (str) {
		return elm$core$Maybe$Just(
			author$project$Food$Slug$Slug(str));
	});
var author$project$Route$Cart = {$: 'Cart'};
var author$project$Route$Food = function (a) {
	return {$: 'Food', a: a};
};
...
var author$project$Route$parser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			elm$url$Url$Parser$map,
			author$project$Route$Food,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('food'),
				author$project$Food$Slug$urlParser)),
			A2(
			elm$url$Url$Parser$map,
...
var author$project$Main$init = F4(
	function (maybeCart, maybeViewer, url, navKey) {
		var cart = author$project$Cart$Filled(
			elm$core$Dict$fromList(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'1',
						A4(author$project$Cart$Item, '1', 'chicken', 599, 5))
					])));
		return A2(
...
var author$project$Api$onCartChange = _Platform_incomingPort('onCartChange', elm$json$Json$Decode$value);
var author$project$Api$cartChanges = F2(
	function (toMsg, cartDecoder) {
		return author$project$Api$onCartChange(
			function (value) {
				return toMsg(
					elm$core$Result$toMaybe(
						A2(elm$json$Json$Decode$decodeValue, cartDecoder, value)));
			});
	});
var author$project$Page$Cart$CartUpdated = function (a) {
	return {$: 'CartUpdated', a: a};
};
var author$project$Page$Cart$GotSession = function (a) {
	return {$: 'GotSession', a: a};
};
...
var author$project$Viewer$Viewer = F4(
	function (a, b, c, d) {
		return {$: 'Viewer', a: a, b: b, c: c, d: d};
	});
var author$project$Viewer$decoder = A4(
...
var author$project$Page$Cart$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2(
				author$project$Session$changes,
				author$project$Page$Cart$GotSession,
				author$project$Session$navKey(model.session)),
				A2(author$project$Api$cartChanges, author$project$Page$Cart$CartUpdated, author$project$Cart$decoder)
			]));
};
var author$project$Page$Food$GotSession = function (a) {
	return {$: 'GotSession', a: a};
};
var author$project$Page$Food$subscriptions = function (model) {
	return A2(
		author$project$Session$changes,
		author$project$Page$Food$GotSession,
		author$project$Session$navKey(model.session));
};
	...
	switch (model.$) {
		...
		case 'Food':
			...
			return A2(
				elm$core$Platform$Sub$map,
				author$project$Main$GotFoodMsg,
				author$project$Page$Food$subscriptions(food));
		case 'Cart':
			var cart = model.a;
			return A2(
				elm$core$Platform$Sub$map,
				author$project$Main$GotCartMsg,
				author$project$Page$Cart$subscriptions(cart));
		default:
			return elm$core$Platform$Sub$none;
	}
};
...
var author$project$Api$storeCart = _Platform_outgoingPort('storeCart', elm$core$Basics$identity);
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'QtyChanged':
				var id = msg.a;
				var strQty = msg.b;
				var qty = elm$core$String$toInt(strQty);
				var func = elm$core$Maybe$map(
					function (item) {
						return _Utils_update(
							item,
							{
								qty: A2(elm$core$Maybe$withDefault, 1, qty)
							});
					});
				var newDict = function () {
					...
					if (_n1.$ === 'Empty') {
						...
						var dict = _n1.a;
						return A3(elm$core$Dict$update, id, func, dict);
					}
				}();
				var json = A3(elm$json$Json$Encode$dict, elm$core$Basics$identity, author$project$Api$encodeItem, newDict);
				return _Utils_Tuple2(
					model,
					elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								author$project$Api$storeCart(json),
								A2(
								elm$core$Debug$log,
								elm$core$Debug$toString(json),
								elm$core$Platform$Cmd$none)
							])));
			default:
				var maybeCart = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							cart: A2(elm$core$Maybe$withDefault, author$project$Cart$Empty, maybeCart)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$Page$Food$Failed = {$: 'Failed'};
var author$project$Page$Food$Loaded = function (a) {
	return {$: 'Loaded', a: a};
};
var author$project$Page$Food$update = F2(
	function (msg, model) {
		if (msg.$ === 'GotSession') {
			var session = msg.a;
			return _Utils_Tuple2(
			...
			if (msg.a.$ === 'Ok') {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							food: author$project$Page$Food$Loaded(food)
						}),
					elm$core$Platform$Cmd$none);
			} else {
				var error = msg.a.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{food: author$project$Page$Food$Failed}),
					elm$core$Platform$Cmd$none);
			}
		}
	});
...
var author$project$Page$Home$update = F2(
	function (msg, model) {
		if (msg.$ === 'GotSession') {
			...
			if (msg.a.$ === 'Ok') {
				var foodGrid = msg.a.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							foodGrid: author$project$Page$Home$Loaded(foodGrid)
						}),
					elm$core$Platform$Cmd$none);
			} else {
				var error = msg.a.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{foodGrid: author$project$Page$Home$Failed}),
					elm$core$Platform$Cmd$none);
			}
		}
	});
var author$project$Api$storeViewer = function (_n0) {
	var uid = _n0.a;
	var tok = _n0.b;
	var eml = _n0.c;
	var cus = _n0.d;
				...
				elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'token',
							elm$json$Json$Encode$string(tok)),
							_Utils_Tuple2(
							'email',
							elm$json$Json$Encode$string(eml)),
							_Utils_Tuple2(
							'customer',
							elm$json$Json$Encode$int(cus))
						])))
			]));
...
var author$project$Api$post = F4(
	function (url, toResult, body, decoder) {
		return author$project$Api$Endpoint$request(
			{
				body: body,
				expect: A2(elm$http$Http$expectJson, toResult, decoder),
...
var author$project$Api$Endpoint$login = author$project$Api$Endpoint$url(
	_List_fromArray(
		['login']));
...
var author$project$Page$Login$login = function (_n0) {
	...
	return A4(author$project$Api$post, author$project$Api$Endpoint$login, author$project$Page$Login$CompletedLogin, body, author$project$Viewer$decoder);
};
		...
		switch (msg.$) {
			...
			default:
				if (msg.a.$ === 'Err') {
						...
						_Utils_update(
							model,
							{
								problems: A2(
									...
									_List_fromArray(
										[
											author$project$Page$Login$ServerError(errorString)
										]))
							}),
						elm$core$Platform$Cmd$none);
				} else {
					...
					return _Utils_Tuple2(
						model,
						author$project$Api$storeViewer(viewer));
				}
		}
	});
...
var author$project$Api$Endpoint$register = author$project$Api$Endpoint$url(
	_List_fromArray(
		['register']));
...
var author$project$Page$Register$register = function (_n0) {
	...
	return A4(
		...
		author$project$Api$Endpoint$register,
...
var author$project$Page$Register$Confirm = {$: 'Confirm'};
var author$project$Page$Register$Email = {$: 'Email'};
var author$project$Page$Register$Firstname = {$: 'Firstname'};
var author$project$Page$Register$Lastname = {$: 'Lastname'};
var author$project$Page$Register$Password = {$: 'Password'};
var author$project$Page$Register$fieldsToValidate = _List_fromArray(
	[author$project$Page$Register$Firstname, author$project$Page$Register$Lastname, author$project$Page$Register$Email, author$project$Page$Register$Password, author$project$Page$Register$Confirm]);
...
var author$project$Page$Register$trimFields = function (form) {
	return author$project$Page$Register$Trimmed(
		{
			confirm: elm$core$String$trim(form.confirm),
			email: elm$core$String$trim(form.email),
				...
				switch (field.$) {
					case 'Firstname':
						return elm$core$String$isEmpty(form.firstname) ? _List_fromArray(
							['firstname can\'t be blank.']) : _List_Nil;
					case 'Lastname':
						return elm$core$String$isEmpty(form.lastname) ? _List_fromArray(
							['lastname can\'t be blank.']) : _List_Nil;
					case 'Email':
						return elm$core$String$isEmpty(form.email) ? _List_fromArray(
							['email can\'t be blank.']) : _List_Nil;
					case 'Password':
						return elm$core$String$isEmpty(form.password) ? _List_fromArray(
							['password can\'t be blank.']) : _List_Nil;
					default:
						return elm$core$String$isEmpty(form.confirm) ? _List_fromArray(
							['confirm password can\'t be blank.']) : ((!_Utils_eq(form.password, form.confirm)) ? _List_fromArray(
							['password does not match']) : _List_Nil);
				}
			}());
	});
						...
						_Utils_update(
							model,
							{
								problems: A2(
									...
									_List_fromArray(
										[
											author$project$Page$Register$ServerError(errorString)
										]))
							}),
						elm$core$Platform$Cmd$none);
				} else {
				...
				case 'GotFoodMsg':
					if (_n0.b.$ === 'Food') {
						...
						return A4(
							...
							author$project$Main$GotFoodMsg,
							model,
							A2(author$project$Page$Food$update, subMsg, food));
					} else {
						break _n0$9;
					}
				case 'GotCartMsg':
					if (_n0.b.$ === 'Cart') {
						...
						return A4(
							...
							author$project$Main$GotCartMsg,
							model,
							A2(author$project$Page$Cart$update, subMsg, cart));
					} else {
						break _n0$9;
					}
				default:
					if (_n0.b.$ === 'Redirect') {
						...
						var cart = _n2.b;
						return _Utils_Tuple2(
							A2(author$project$Main$Redirect, session, cart),
							A2(
								author$project$Route$replaceUrl,
								author$project$Session$navKey(session),
								author$project$Route$Home));
...
var author$project$Page$Cart$calcTotal = function (dict) {
	var list = elm$core$Dict$values(dict);
...
var author$project$Page$Cart$viewCartHeader = A2(
	elm$html$Html$h2,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('cart icon')
				]),
			_List_Nil),
			A2(
			elm$html$Html$div,
...
var author$project$Page$Cart$QtyChanged = F2(
	function (a, b) {
		return {$: 'QtyChanged', a: a, b: b};
	});
...
var author$project$Page$Cart$viewRow = function (item) {
	return A2(
		elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						elm$core$String$fromFloat(item.price / 100.0))
					])),
				A2(
				elm$html$Html$td,
				_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('ui mini input ')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												...
												author$project$Page$Cart$QtyChanged(item.id)),
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'$' + elm$core$String$fromFloat((item.price * item.qty) / 100.0))
					]))
			]));
};
...
var author$project$Page$Cart$viewCart = function (cart) {
	if (cart.$ === 'Empty') {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('ui center aligned container')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('shopping cart icon')
								]),
							_List_Nil),
							elm$html$Html$text(' Your shopping cart is empty')
						]))
				]));
	} else {
		var dict = cart.a;
		return A2(
			...
			_List_fromArray(
				[
					author$project$Page$Cart$viewCartHeader,
					A2(
					elm$html$Html$table,
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('ui selectable unstackable basic padded large table')
						]),
					_List_fromArray(
						[
							A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$Attributes$class('seven wide')
												]),
											_List_fromArray(
												[
											...
											_List_fromArray(
												[
													elm$html$Html$Attributes$class('three wide')
												]),
											_List_fromArray(
												[
							...
							A2(
								elm$core$List$map,
								author$project$Page$Cart$viewRow,
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													A2(elm$html$Html$Attributes$attribute, 'colspan', '4')
												]),
											_List_fromArray(
												[
													A2(
													...
													_List_fromArray(
														[
															elm$html$Html$Attributes$class('ui big label')
														]),
													_List_fromArray(
														[
															elm$html$Html$text('Cart Total'),
															A2(
															elm$html$Html$div,
															_List_fromArray(
																[
															...
															_List_fromArray(
																[
																	...
																	'$' + elm$core$String$fromFloat(
																		author$project$Page$Cart$calcTotal(dict)))
																]))
														])),
													A2(
													elm$html$Html$div,
													_List_fromArray(
														[
															elm$html$Html$Attributes$class('ui right floated primary labeled icon large button')
														]),
													_List_fromArray(
														[
															A2(
...
var author$project$Page$Cart$view = function (model) {
	return {
		content: A2(
			...
			_List_fromArray(
				[
					author$project$Page$Cart$viewCart(model.cart)
				])),
		title: 'Cart'
	};
};
var author$project$Food$metadata = function (_n0) {
	var internals = _n0.a;
	return internals.metadata;
};
var author$project$Food$slug = function (_n0) {
	var internals = _n0.a;
	return internals.slug;
};
var author$project$Page$Food$view = function (model) {
	var _n0 = model.food;
	switch (_n0.$) {
		case 'Loaded':
			var food = _n0.a;
			var slug = author$project$Food$slug(food);
			var restaurant = author$project$Food$metadata(food).restaurant;
			var price = author$project$Food$metadata(food).price;
			var name = author$project$Food$metadata(food).name;
			var id = author$project$Food$metadata(food).id;
			var description = author$project$Food$metadata(food).description;
			return {
				content: A2(
					elm$html$Html$div,
					_List_Nil,
		...
		case 'Loading':
			return {
				content: elm$html$Html$text('loading'),
				title: 'Food'
			};
		case 'LoadingSlowly':
			return {
				content: elm$html$Html$text('loading slowly'),
				title: 'Food'
			};
		default:
			return {
				content: elm$html$Html$text('failed'),
				title: 'Food'
			};
	}
};
var author$project$Page$Home$viewBanner = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$text('neora one')
				])),
			A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('ui large primary button')
				]),
			_List_fromArray(
				[
					elm$html$Html$text('Preorder now')
				]))
		]));
var author$project$FoodGrid$values = function (_n0) {
	var info = _n0.a;
	return info.values;
};
...
var author$project$Page$Home$viewPreview = function (food) {
	var slug = author$project$Food$slug;
	var price = author$project$Food$metadata(food).price;
	var name = author$project$Food$metadata(food).name;
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('ui raised card')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$src('../../../asset/images/shangwei1.jpg')
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('ui content')
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('ui compact primary button')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('shop icon')
							]),
						_List_Nil),
...
var author$project$Page$Home$viewFoods = function (foodGrid) {
	return A2(
		elm$core$List$map,
		author$project$Page$Home$viewPreview,
		author$project$FoodGrid$values(foodGrid));
};
var author$project$Page$Home$view = function (model) {
	return {
		content: A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('ui vertical center aligned segment')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('ui container vertical segment')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('ui four doubling link cards')
										]),
									function () {
										var _n0 = model.foodGrid;
										switch (_n0.$) {
											case 'Loaded':
												var foodGrid = _n0.a;
												return author$project$Page$Home$viewFoods(foodGrid);
											case 'Loading':
												return _List_fromArray(
													[
											...
											case 'LoadingSlowly':
												return _List_fromArray(
													[
														elm$html$Html$text('Loading slowly')
													]);
											default:
												return _List_fromArray(
													[
...
var author$project$Page$Login$viewError = function (problems) {
	if (!problems.b) {
		return elm$html$Html$text('');
	} else {
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(elm$core$List$map, author$project$Page$Login$viewProblem, problems))
				]));
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('ui fluid large submit primary button')
					]),
				_List_fromArray(
					[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('six wide column')
								]),
							_List_fromArray(
								[
									A2(
									...
									author$project$Page$Login$viewError(model.problems),
...
var author$project$Page$Register$viewError = function (problems) {
	if (!problems.b) {
		return elm$html$Html$text('');
	} else {
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(elm$core$List$map, author$project$Page$Register$viewProblem, problems))
				]));
	}
};
var author$project$Page$Register$ConfirmedPass = function (a) {
	return {$: 'ConfirmedPass', a: a};
};
var author$project$Page$Register$EnteredEmail = function (a) {
	return {$: 'EnteredEmail', a: a};
};
var author$project$Page$Register$EnteredFirst = function (a) {
	return {$: 'EnteredFirst', a: a};
};
var author$project$Page$Register$EnteredLast = function (a) {
	return {$: 'EnteredLast', a: a};
};
var author$project$Page$Register$EnteredPass = function (a) {
	return {$: 'EnteredPass', a: a};
};
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$type_('text'),
										elm$html$Html$Events$onInput(author$project$Page$Register$EnteredFirst),
										elm$html$Html$Attributes$value(form.firstname),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$type_('text'),
										elm$html$Html$Events$onInput(author$project$Page$Register$EnteredLast),
										elm$html$Html$Attributes$value(form.lastname),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$type_('text'),
										elm$html$Html$Events$onInput(author$project$Page$Register$EnteredPass),
										elm$html$Html$Attributes$value(form.password),
										elm$html$Html$Attributes$placeholder('Password')
									]),
								_List_Nil)
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$type_('text'),
										elm$html$Html$Events$onInput(author$project$Page$Register$ConfirmedPass),
						...
						[
							...
							_List_fromArray(
								[
									...
									author$project$Page$Register$viewError(model.problems),
...
var author$project$Skeleton$Home = {$: 'Home'};
var author$project$Skeleton$Other = {$: 'Other'};
var elm$html$Html$h4 = _VirtualDom_node('h4');
var author$project$Skeleton$viewFooter = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('ui vertical segment footer')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('ui section divider')
				]),
			_List_Nil),
			A2(
			elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('ui stackable centered grid')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('four wide center aligned column')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											elm$html$Html$text('Group 1')
										])),
									A2(
									elm$html$Html$div,
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('ui link list')
										]),
									_List_fromArray(
										[
											A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('ui horizontal  small divided link list')
						]),
					_List_fromArray(
						[
							A2(
...
var author$project$Skeleton$userRightMenu = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('right item')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('my-dropdown')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('ui dropdown label'),
							elm$html$Html$Attributes$href('')
						]),
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('my-dropdown-content menu')
								]),
							_List_fromArray(
								[
									A2(
	...
	function (maybeViewer, page) {
		var rightMenu = function () {
			if (maybeViewer.$ === 'Just') {
				...
				return _List_fromArray(
					[author$project$Skeleton$userRightMenu]);
			} else {
				return _List_fromArray(
					[author$project$Skeleton$userRightMenu]);
			}
		...
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('ui header secondary menu')
				]),
			A2(
				elm$core$List$cons,
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('my-logo'),
									author$project$Route$href(author$project$Route$Home)
								]),
							_List_fromArray(
								[
									elm$html$Html$text('neora')
								]))
						])),
				rightMenu));
	});
		...
		return {
			body: _List_fromArray(
				[
					...
					A2(
						elm$core$List$cons,
						A2(author$project$Skeleton$viewHeader, maybeViewer, page),
						A2(
							elm$core$List$cons,
							content,
							_List_fromArray(
...
var author$project$Main$view = function (model) {
	...
	var viewPage = F3(
		function (page, toMsg, config) {
			var _n1 = A3(author$project$Skeleton$view, viewer, page, config);
			var title = _n1.title;
			var body = _n1.body;
			return {
				body: A2(
	...
	switch (model.$) {
		case 'Redirect':
			return A3(author$project$Skeleton$view, viewer, author$project$Skeleton$Other, author$project$Page$Blank$view);
		case 'NotFound':
			return A3(author$project$Skeleton$view, viewer, author$project$Skeleton$Other, author$project$Page$Blank$view);
		case 'Home':
			var home = model.a;
		...
		case 'Food':
			...
			return A3(
				...
				author$project$Skeleton$Other,
				author$project$Main$GotFoodMsg,
				author$project$Page$Food$view(food));
		default:
			var cart = model.a;
			return A3(
				viewPage,
				author$project$Skeleton$Other,
				author$project$Main$GotCartMsg,
				author$project$Page$Cart$view(cart));
	}
};
...
_Platform_export({'Main':{'init':author$project$Main$main(elm$json$Json$Decode$value)({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Cart.Item":{"args":[],"type":"{ id : String.String, name : String.String, price : Basics.Int, qty : Basics.Int }"},"Food.Internals":{"args":[],"type":"{ slug : Food.Slug.Slug, metadata : Food.Metadata }"},"Food.Metadata":{"args":[],"type":"{ id : Basics.Int, name : String.String, restaurant : String.String, price : Basics.Int, description : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"ChangedRoute":["Maybe.Maybe Route.Route"],"ChangedUrl":["Url.Url"],"ClickedLink":["Browser.UrlRequest"],"GotHomeMsg":["Page.Home.Msg"],"GotLoginMsg":["Page.Login.Msg"],"GotRegisterMsg":["Page.Register.Msg"],"GotFoodMsg":["Page.Food.Msg"],"GotCartMsg":["Page.Cart.Msg"],"GotSession":["Session.Session"]}},"Page.Cart.Msg":{"args":[],"tags":{"GotSession":["Session.Session"],"QtyChanged":["String.String","String.String"],"CartUpdated":["Maybe.Maybe Cart.Cart"]}},"Page.Food.Msg":{"args":[],"tags":{"GotSession":["Session.Session"],"CompletedLoadFood":["Result.Result Http.Error (Food.Food Food.Full)"]}},"Page.Home.Msg":{"args":[],"tags":{"GotSession":["Session.Session"],"CompletedGridLoad":["Result.Result Http.Error (FoodGrid.FoodGrid (Food.Food Food.Preview))"]}},"Page.Login.Msg":{"args":[],"tags":{"SubmittedForm":[],"GotSession":["Session.Session"],"EnteredEmail":["String.String"],"EnteredPassword":["String.String"],"CompletedLogin":["Result.Result Http.Error Viewer.Viewer"]}},"Page.Register.Msg":{"args":[],"tags":{"GotSession":["Session.Session"],"SubmittedForm":[],"EnteredFirst":["String.String"],"EnteredLast":["String.String"],"EnteredEmail":["String.String"],"EnteredPass":["String.String"],"ConfirmedPass":["String.String"],"CompletedRegister":["Result.Result Http.Error String.String"]}},"Route.Route":{"args":[],"tags":{"Home":[],"Root":[],"Login":[],"Logout":[],"Food":["Food.Slug.Slug"],"Cart":[],"Register":[]}},"Session.Session":{"args":[],"tags":{"LoggedIn":["Browser.Navigation.Key","Viewer.Viewer"],"Guest":["Browser.Navigation.Key"]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Cart.Cart":{"args":[],"tags":{"Empty":[],"Filled":["Dict.Dict String.String Cart.Item"]}},"Food.Food":{"args":["a"],"tags":{"Food":["Food.Internals","a"]}},"Food.Full":{"args":[],"tags":{"Full":[]}},"Food.Preview":{"args":[],"tags":{"Preview":[]}},"Food.Slug.Slug":{"args":[],"tags":{"Slug":["String.String"]}},"FoodGrid.FoodGrid":{"args":["a"],"tags":{"FoodGrid":["{ values : List.List a }"]}},"Viewer.Viewer":{"args":[],"tags":{"Viewer":["Basics.Int","String.String","String.String","Basics.Int"]}},"Browser.Navigation.Key":{"args":[],"tags":{"Key":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"List.List":{"args":["a"],"tags":{}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));